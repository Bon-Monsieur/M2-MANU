...
int main(){
    ...
    // Test 3: Manual matrix construction
    std::cout << "Test 3: Manual Matrix Construction" << std::endl;
    sparse_matrix<double> mat3(3);
    row<double> r0(1.0, 0);
    r0.append(2.0, 2);
    *mat3.item(0) = r0;
    ...
    *mat3.item(2) = r2;
    ...
    std::cout << "Created 3x3 matrix:" << std::endl;
    print(mat3);
    std::cout << std::endl;
    ...
    sparse_matrix<double> matA(3, 1.0);
    sparse_matrix<double> matB(3, 2.0);
